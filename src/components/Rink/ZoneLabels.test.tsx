...
describe('Zone Labels', () => {
  ...
  it('should have subtle styling (gray text, small font)', () => {
    ...
    // Check for gray text and responsive font size classes (text-xs on mobile, text-sm on larger screens)
    expect(awayLabel).toHaveClass('text-gray-400', 'text-xs');
    expect(homeLabel).toHaveClass('text-gray-400', 'text-xs');
  });
